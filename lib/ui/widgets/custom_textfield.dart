...
import 'package:tezda/ui/widgets/input_fornatter/thousands_separator_formatter.dart';
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    border: OutlineInputBorder(
                        ...
                        borderRadius:
                            BorderRadius.circular(widget.radius ?? 50.r)),
                    focusedBorder: OutlineInputBorder(
                        borderSide: const BorderSide(color: BrandColors.dark),
                        borderRadius:
                            BorderRadius.circular(widget.radius ?? 5.r)),
                    enabledBorder: OutlineInputBorder(
                        borderSide: BorderSide(
                            color: widget.borderColor ?? BrandColors.secondary),
                        borderRadius:
                            BorderRadius.circular(widget.radius ?? 5.r)),
                    disabledBorder: OutlineInputBorder(
                        borderSide: BorderSide(
                            color: widget.borderColor ?? BrandColors.dark50),
                        borderRadius:
                            BorderRadius.circular(widget.radius ?? 5.r)),
