...
String iosAppLink = 'https://apps.apple.com/app/midddleman/id6505026022';
String androidAppLink =
    'https://play.google.com/store/apps/details?id=com.app.midddleman';

Future selectImageSource(
    {required BuildContext context, required ValueChanged<ImageSource> func}) {
  final bool initialNavStatus = locator<UtilityService>().showNav;
  locator<UtilityService>().setShowNav(false);
